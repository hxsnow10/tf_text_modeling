...
def get_config():
    ...
    class Config():
        ...
        tags_path="data/clf/tags.txt"
        train_paths=["data/clf/train.txt"]
        dev_paths=["data/clf/dev.txt"]
        ...
        _words_vec=Vec( 
            vec_path='data/clf/word_vec.txt',
            trainable=True,
            vocab_path='data/clf/word_vec.txt',
        ...
        #'''
        _chars_vec=Vec(
            vec_path='data/clf/char_vec.txt',
            trainable=True,
            vocab_path='data/clf/char_vec.txt',
            vocab_skip_head=True,
            max_vocab_size=200000,
            vec_size=None)
        #'''
        ...
        if 'cnn' in text_model:
            cnn_layer_num=1
            gated=False # gating of convolution
            seq_len=200
        ...
        del z
        model_dir='./RESULT/clf/model'+suffix
        summary_dir='./RESULT/clf/log'+suffix
