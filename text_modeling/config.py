...
def get_config():
    ...
    class Config():
        ...
        tags_path="data/en/tags.txt"
        train_paths=["data/en/train.txt"]
        dev_paths=["data/en/dev.txt"]

        data_type="clf"
        # tags+seq; sparse_tags+seq; 
        ...
        del z
        model_dir='./SA/model'+suffix
        summary_dir='./SA/log'+suffix
